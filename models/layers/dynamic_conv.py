...
class _ConvNd(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,padding, dilation, transposed, output_padding, groups, bias):
        ...
        if self.partial is not None:
            ...
            self.weight = Parameter(torch.Tensor(self.partial, *kernel_size))
        else:
...
def dynamic_conv2d(is_first, partial=None):
    ...
    class DynamicConv2d(_ConvNd):
        ...
        def __init__(self, in_channels, out_channels, kernel_size, stride=1,padding=0, dilation=1, groups=1, bias=False):
            ...
            padding = _pair(padding)
            dilation = _pair(dilation)
            super(DynamicConv2d, self).__init__(in_channels, out_channels, kernel_size, stride, padding, dilation,False, _pair(0), groups, bias)
        ...
        def forward(self, inputs):
            ...
            conv_rlt = F.conv2d(input, dynamic_weight, self.bias, self.stride,self.padding, self.dilation, groups)
